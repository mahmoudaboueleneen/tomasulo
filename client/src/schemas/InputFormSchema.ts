...
const InputFormSchema = z.object({
    ...
    LoadLatency: z.preprocess((value) => parseInt(value as string), z.number().positive().int()),
    StoreLatency: z.preprocess((value) => parseInt(value as string), z.number().positive().int()),
